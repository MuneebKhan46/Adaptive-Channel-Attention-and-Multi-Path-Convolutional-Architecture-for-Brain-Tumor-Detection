...
def eca_block(input_feature, k_size=3, activation='sigmoid'):
    ...
    # 1D Convolution for channel-wise attention
    conv1d = layers.Conv1D(
        1, kernel_size=k_size, padding='same', use_bias=False, activation=activation
    )(avg_pool)
...
#     x = MaxPooling2D((2, 2))(x)  # Reduced spatial dimensions here
...
#     conv_path1 = eca_block(conv_path1, activation=eca_activation)
#     conv_path1 = layers.Activation('relu')(conv_path1)

#     # Path 2
#     conv_path2 = Conv2D(64, (3, 3), padding='same')(x)
#     conv_path2 = eca_block(conv_path2, activation=eca_activation)
#     conv_path2 = layers.Activation('relu')(conv_path2)

#     # Path 3
#     maxpool_path = MaxPooling2D((2, 2))(x)  # Reduced spatial dimensions here
#     dropout_path = Dropout(0.25)(maxpool_path)

#     # Concatenate all paths at the end of Block 1
#     block1_output = Concatenate()([conv_path1, conv_path2, dropout_path])

#     # Add MaxPooling after Block 1 to reduce dimensions
...
#     conv_path1_b2 = eca_block(conv_path1_b2, activation=eca_activation)
#     conv_path1_b2 = layers.Activation('relu')(conv_path1_b2)

#     # Path 2
#     conv_path2_b2 = Conv2D(128, (3, 3), padding='same')(block1_output)
#     conv_path2_b2 = eca_block(conv_path2_b2, activation=eca_activation)
#     conv_path2_b2 = layers.Activation('relu')(conv_path2_b2)

#     # Path 3
#     maxpool_path_b2 = MaxPooling2D((2, 2))(block1_output)  # Reduced dimensions
...
#     # Add MaxPooling after Block 2 to reduce dimensions
#     block2_output = MaxPooling2D((2, 2))(block2_output)

#     # Additional Conv Layers between Block 2 and the output
#     x = Conv2D(128, (5, 5), padding='same')(block2_output)
#     x = eca_block(x, activation=eca_activation)
#     x = layers.Activation('relu')(x)

#     x = MaxPooling2D((2, 2))(x)  # Reduced dimensions here
...
#     # Output Layer with 4 categories (Softmax activation)
...
with strategy.scope():
    ...
    model_checkpoint = tf.keras.callbacks.ModelCheckpoint(
        filepath='/Untitled Folder/Models/New_Model3(softmax).h5',
        save_best_only=True,
